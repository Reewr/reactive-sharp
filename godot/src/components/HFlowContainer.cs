...
{
    public class HFlowContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GHFlowContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GHFlowContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GHFlowContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GHFlowContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GHFlowContainer node)
        {
            var castedNode = (Godot.HFlowContainer)node.Node;
