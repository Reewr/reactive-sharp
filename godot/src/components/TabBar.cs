...
namespace ReactiveSharpGodot.Components
{
    public class TabBar : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GTabBar>
    {
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GTabBar node)
        {
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n40)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n40;
            }
            ...
            if (EditorStateChanged is System.Action e31)
            {
                NodeStateManager.AddEventHandler(castedNode, "EditorStateChanged", e31);
                castedNode.EditorStateChanged += e31;
            }
