...
namespace ReactiveSharpGodot.Components
{
    public class VScrollBar : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GVScrollBar>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GVScrollBar>? CustomNodeHandling { protected get; init; }
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GVScrollBar node)
        {
            ...
            if (EditorStateChanged is System.Action e26)
            {
                NodeStateManager.AddEventHandler(castedNode, "EditorStateChanged", e26);
                castedNode.EditorStateChanged += e26;
            }
