...
{
    public class BoxContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GBoxContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GBoxContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GBoxContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GBoxContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GBoxContainer node)
        {
