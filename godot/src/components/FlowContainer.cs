namespace ReactiveSharpGodot.Components
{
    public class FlowContainer : Container
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.INode> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GFlowContainer(), builtChildren);
