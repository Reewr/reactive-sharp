...
{
    public class MarginContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GMarginContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GMarginContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GMarginContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GMarginContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GMarginContainer node)
        {
            var castedNode = (Godot.MarginContainer)node.Node;
