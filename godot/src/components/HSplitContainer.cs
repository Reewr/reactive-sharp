...
{
    public class HSplitContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GHSplitContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GHSplitContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GHSplitContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GHSplitContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GHSplitContainer node)
        {
            var castedNode = (Godot.HSplitContainer)node.Node;
            ...
            if (PreSortChildren is System.Action e1)
            {
                NodeStateManager.AddEventHandler(castedNode, "PreSortChildren", e1);
                castedNode.PreSortChildren += e1;
            }

            if (SortChildren is System.Action e2)
            {
                NodeStateManager.AddEventHandler(castedNode, "SortChildren", e2);
                castedNode.SortChildren += e2;
            }
