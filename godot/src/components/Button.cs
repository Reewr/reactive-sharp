namespace ReactiveSharpGodot.Components
{
    public class Button : BaseButton
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.INode> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GButton(), builtChildren);
