...
{
    public class ProgressBar : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GProgressBar>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GProgressBar>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GProgressBar Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GProgressBar();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GProgressBar node)
        {
            ...
            {
                NodeStateManager.AddPropertyState(castedNode, "ShowPercentage", castedNode.ShowPercentage);
                castedNode.ShowPercentage = n1;
            }

            if (Indeterminate is System.Boolean n2)
            {
                NodeStateManager.AddPropertyState(castedNode, "Indeterminate", castedNode.Indeterminate);
                castedNode.Indeterminate = n2;
            }

            if (EditorPreviewIndeterminate is System.Boolean n3)
            {
                NodeStateManager.AddPropertyState(castedNode, "EditorPreviewIndeterminate", castedNode.EditorPreviewIndeterminate);
