...
{
    public class PanelContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GPanelContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GPanelContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GPanelContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GPanelContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GPanelContainer node)
        {
            var castedNode = (Godot.PanelContainer)node.Node;
