...
{
    public class Container : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GContainer node)
        {
            var castedNode = (Godot.Container)node.Node;
