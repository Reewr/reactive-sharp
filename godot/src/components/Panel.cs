...
{
    public class Panel : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GPanel>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GPanel>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GPanel Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GPanel();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GPanel node)
        {
            var castedNode = (Godot.Panel)node.Node;
