...
namespace ReactiveSharpGodot.Components
{
    public class BaseButton : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GBaseButton>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GBaseButton>? CustomNodeHandling { protected get; init; }
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GBaseButton node)
        {
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n38)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n38;
            }
