...
namespace ReactiveSharpGodot.Components
{
    public class MenuBar : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GMenuBar>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GMenuBar>? CustomNodeHandling { protected get; init; }
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GMenuBar node)
        {
            ...
            {
                NodeStateManager.AddPropertyState(castedNode, "StartIndex", castedNode.StartIndex);
            ...
            {
                NodeStateManager.AddPropertyState(castedNode, "PreferGlobalMenu", castedNode.PreferGlobalMenu);
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n34)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n34;
            }
