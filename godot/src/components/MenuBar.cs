namespace ReactiveSharpGodot.Components
{
    public class MenuBar : Control
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.INode> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GMenuBar(), builtChildren);
