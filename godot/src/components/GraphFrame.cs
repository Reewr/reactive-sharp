namespace ReactiveSharpGodot.Components
{
    public class GraphFrame : GraphElement
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.INode> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GGraphFrame(), builtChildren);
