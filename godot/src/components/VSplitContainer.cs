...
{
    public class VSplitContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GVSplitContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GVSplitContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GVSplitContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GVSplitContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GVSplitContainer node)
        {
            var castedNode = (Godot.VSplitContainer)node.Node;
