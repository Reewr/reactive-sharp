...
namespace ReactiveSharpGodot.Components
{
    public class CenterContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GCenterContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GCenterContainer>? CustomNodeHandling { protected get; init; }
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GCenterContainer node)
        {
            ...
            {
                NodeStateManager.AddPropertyState(castedNode, "UseTopLeft", castedNode.UseTopLeft);
