...
{
    public class CheckBox : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GCheckBox>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GCheckBox>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GCheckBox Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GCheckBox();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GCheckBox node)
        {
            var castedNode = (Godot.CheckBox)node.Node;
