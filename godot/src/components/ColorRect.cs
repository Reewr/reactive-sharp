...
{
    public class ColorRect : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GColorRect>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GColorRect>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GColorRect Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GColorRect();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GColorRect node)
        {
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n29)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n29;
            }
