...
{
    public class VBoxContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GVBoxContainer>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GVBoxContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GVBoxContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GVBoxContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GVBoxContainer node)
        {
            var castedNode = (Godot.VBoxContainer)node.Node;
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n30)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n30;
            }
