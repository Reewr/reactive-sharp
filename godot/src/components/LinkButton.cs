namespace ReactiveSharpGodot.Components
{
    public class LinkButton : BaseButton
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.INode> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GLinkButton(), builtChildren);
