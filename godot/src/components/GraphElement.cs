...
namespace ReactiveSharpGodot.Components
{
    public class GraphElement : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GGraphElement>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GGraphElement>? CustomNodeHandling { protected get; init; }
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GGraphElement node)
        {
            ...
            if (TooltipAutoTranslateMode is Godot.Node.AutoTranslateModeEnum n33)
            {
                NodeStateManager.AddPropertyState(castedNode, "TooltipAutoTranslateMode", castedNode.TooltipAutoTranslateMode);
                castedNode.TooltipAutoTranslateMode = n33;
            }
