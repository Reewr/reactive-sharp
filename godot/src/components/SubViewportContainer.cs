...
{
    public class SubViewportContainer : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GSubViewportContainer>
    {
        public System.Boolean? Stretch { protected get; init; }
        public System.Int32? StretchShrink { protected get; init; }
        public System.Boolean? MouseTarget { protected get; init; }
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GSubViewportContainer>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GSubViewportContainer Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GSubViewportContainer();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GSubViewportContainer node)
        {
            var castedNode = (Godot.SubViewportContainer)node.Node;
            if (Stretch is System.Boolean n0)
            {
                NodeStateManager.AddPropertyState(castedNode, "Stretch", castedNode.Stretch);
                castedNode.Stretch = n0;
            }

            if (StretchShrink is System.Int32 n1)
            {
                NodeStateManager.AddPropertyState(castedNode, "StretchShrink", castedNode.StretchShrink);
                castedNode.StretchShrink = n1;
            }

            if (MouseTarget is System.Boolean n2)
            {
                NodeStateManager.AddPropertyState(castedNode, "MouseTarget", castedNode.MouseTarget);
                castedNode.MouseTarget = n2;
            }
