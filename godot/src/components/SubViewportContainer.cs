namespace ReactiveSharpGodot.Components
{
    public class SubViewportContainer : Container
    {
        ...
        public override ReactiveSharpGodot.IGNode Build(System.Collections.Generic.List<ReactiveSharp.Node> builtChildren) => DefaultBuild(new ReactiveSharpGodot.Nodes.GSubViewportContainer(), builtChildren);
