...
{
    public class CheckButton : ReactiveSharp.NodeComponent<ReactiveSharpGodot.Nodes.GCheckButton>
    {
        ...
        /// </example>
        /// </summary>
        public Action<ReactiveSharpGodot.Nodes.GCheckButton>? CustomNodeHandling { protected get; init; }

        public override ReactiveSharpGodot.Nodes.GCheckButton Build(List<ReactiveSharp.INode> builtChildren)
        {
            var node = new ReactiveSharpGodot.Nodes.GCheckButton();
        ...
        public override void UpdateProperties(ReactiveSharpGodot.Nodes.GCheckButton node)
        {
            var castedNode = (Godot.CheckButton)node.Node;
